...
public class Loader extends Applet {
	...
	public static final String FRAME_TITLE = "Runescape Pirata Public";
	public static final String SERVER_IP = "127.0.0.1";//191.252.111.64
	...
	void setParams() {
		...
		client_parameters.put("27", "3"); //linguagem de algumas frames
		...
		client_parameters.put("3", "jurubeba");
